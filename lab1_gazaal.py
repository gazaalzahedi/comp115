...
my_name = "Gazaal" # Change to your name
my_github_account = "https://github.com/gazaalzahedi/comp115" # Change to your GitHub account
my_hobby = "yoga" # Change to your hobby
...
project_types = ["website application", "game developing"]
