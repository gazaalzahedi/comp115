...
assert gem_counting("abcMPQd", "azbqM") == 3
...
assert students_id(['002', '003', '001', '004']) == 4
...
assert students_id_occurrences(['001', '002', '001']) == {"001": 2, "002": 1}
...
assert word_frequency("I like food. I like pizza") == {"I": 2, "like": 2, "food.": 1, "pizza": 1}    
