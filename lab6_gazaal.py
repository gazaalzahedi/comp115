...
def reverse_str(s):
    ...
    return r
print(reverse_str("COMPSCI"))



assert (reverse_str("COMPSCI")) == ("ICSPMOC") 
...
print(remove_duplicates("gazaal"))

assert (remove_duplicates("gazaal")) == ("gazl")
...
print(find_index("compsci", 'p'))

assert (find_index("compsci", "o")) == 1
...
def project_completion_day(day, days_to_completion):
    ...
    Write your docstring
    """
    completion_date = days_week.index(day) + days_to_completion % 7 
    return days_week[completion_date]
